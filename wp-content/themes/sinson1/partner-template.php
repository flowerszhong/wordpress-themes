 ...
 *
 * @file           partner-template.php
 * @package        Responsive
 * @author         matthew.zhong
 * @copyright      2003 - 2014 CyberChimps
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/sinson/partner-template.php
...
<div id="partner-widget-1">
<?php if (!dynamic_sidebar('home-widget-2')):?>
<div class="widget-wrapper" id="partner-widget-domain">

<div class="widget-title-partner"><h3><?php _e('应用领域', 'responsive');?></h3></div>
<div
...
<div id="partner-widget-2">
<?php responsive_widgets();
// responsive above widgets hook ?>

<?php if (!dynamic_sidebar('home-widget-logos')):?>
<div class="widget-wrapper">

<div class="widget-title-partner"><h3><?php _e('合作伙伴logo', 'responsive');?></h3></div>
<div
