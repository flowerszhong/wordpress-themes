...
<div id="widgets" class="home-widgets">
		<div id="home_widget_1" class="grid col-300 home-widget">
...
<?php responsive_widgets_end();// responsive after widgets hook ?>
		...
		<div id="home_widget_2" class="grid col-300 home-widget">
<?php responsive_widgets();// responsive above widgets hook ?>

<?php if (!dynamic_sidebar('home-widget-products')):?>
				<div class="widget-wrapper">
...
<?php responsive_widgets_end();// after widgets hook ?>
		...
		<div id="home_widget_3" class="grid col-300 fit home-widget">
<?php responsive_widgets();// above widgets hook ?>
