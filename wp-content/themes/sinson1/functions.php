...
require ($template_directory . '/core/includes/category-post.php');
require ($template_directory . '/core/includes/really-simple-gallery-widget/really-simple-gallery-widget.php');
require ($template_directory . '/core/includes/test-widget.php');
