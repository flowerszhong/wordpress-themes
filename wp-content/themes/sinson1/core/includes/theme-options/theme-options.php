	...
	$options = apply_filters('responsive_options_filter', array(
		...
		'home_page' => array(
			...
			array(
				...
				'placeholder' => __('两句话', 'responsive')
			),

			array(
				'title'       => __('标语', 'responsive'),
				'subtitle'    => '',
				'heading'     => '',
				'type'        => 'text',
				'id'          => 'home_slogan',
				'description' => __('填写你的公司标语', 'responsive'),
				'placeholder' => __('梦想还是要有的，万一实现了呢', 'responsive')
			),
			array(
		...
		'footer' => array(
			array(
				'title'       => __('公司全称', 'responsive'),
				'subtitle'    => '',
				'heading'     => '',
				'type'        => 'text',
				'id'          => 'home_company_name',
				'description' => __('公司全称', 'responsive'),
				'placeholder' => __('公司全称', 'responsive')
			),
			array(
				'title'       => __('地址', 'responsive'),
				'subtitle'    => '',
				'heading'     => '',
				'type'        => 'text',
				'id'          => 'home_company_address',
				'description' => __('地址', 'responsive'),
				'placeholder' => __('中南海', 'responsive')
			),
			array(
				'title'       => __('电话', 'responsive'),
				'subtitle'    => '',
				'heading'     => '',
				'type'        => 'text',
				'id'          => 'home_company_tel',
				'description' => __('电话', 'responsive'),
				'placeholder' => __('99999999', 'responsive')
			),
			array(
				'title'       => __('传真', 'responsive'),
				'subtitle'    => '',
				'heading'     => '',
				'type'        => 'text',
				'id'          => 'home_company_fax',
				'description' => __('传真', 'responsive'),
				'placeholder' => __('99999999', 'responsive')
			)
		),
		'layouts' => array(
...
// checkbox value is either 0 or 1
		...
		$input['home_company_name']    = wp_kses_stripslashes($input['home_company_name']);
		$input['home_company_tel']     = wp_kses_stripslashes($input['home_company_tel']);
		$input['home_company_address'] = wp_kses_stripslashes($input['home_company_address']);
		$input['home_company_fax']     = wp_kses_stripslashes($input['home_company_fax']);
