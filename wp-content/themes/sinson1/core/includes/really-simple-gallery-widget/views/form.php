<?php
$from_options = array(
	__('媒体库', 'rsgwidget')=> 'full_library',
	__('特定页面', 'rsgwidget')=> 'post',
	__('图片id', 'rsgwidget')=> 'ids',
);
...
<p>
	<label for="<?php echo $this->get_field_id('title');?>"><?php _e('标题', 'rsgwidget');
?>:</label>
	<input class="widefat" id="<?php echo $this->get_field_id('title');?>" name="<?php echo $this->get_field_name('title');?>" type="text" value="<?php echo esc_attr($title);?>" />
</p>

<p>
	<label for="<?php echo $this->get_field_id('from');?>"><?php _e('选择图片来源', 'rsgwidget');
?></label>
...
?>">
		<label for="<?php echo $this->get_field_id('post_id');?>"><?php _e('特定页面', 'rsgwidget');
?>:</label>
<?php
$dd_page_args = array(
	'depth' => 0,
...
wp_dropdown_pages($dd_page_args);
?>
</span>
...
?>">
		<label for="<?php echo $this->get_field_id('att_ids');?>" class="hide-if-js"><?php _e('Attachment IDs', 'rsgwidget');
?>:</label>
...
<p>
	...
	<label for="<?php echo $this->get_field_id('current_post_images');?>"><?php _e('When on a single page/post, only show its attached images', 'rsgwidget');
?></label><br />
</p>

<p>
	<label for="<?php echo $this->get_field_id('num_images');?>"><?php _e('Number of images to show');
?>:</label>
...
<p>
	...
	<label for="<?php echo $this->get_field_id('show_captions');?>"><?php _e('Show captions', 'rsgwidget');
?></label>
</p>

<?php if (!empty($image_size_options)):?>
<p>
	<label for="<?php echo $this->get_field_id('image_size');?>"><?php _e('Image size', 'rsgwidget');
?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('orderby');?>"><?php _e('Order images by', 'rsgwidget');
?></label>
...
?>">
		<label class="hide-if-js" for="<?php echo $this->get_field_id('order');?>"><?php _e('Order of images', 'rsgwidget');
?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('link_type');?>"><?php _e('Type of link', 'rsgwidget');
?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('before_link_title');?>"><?php _e('Text before link title', 'rsgwidget');
?>:</label>
...
<p>
	<label for="<?php echo $this->get_field_id('link_rel');?>"><?php _e('Link rel attribute', 'rsgwidget');
?>:</label>
