	...
	class RSGWidget extends WP_Widget {
		function RSGWidget() {
			$widget_ops = array(
				...
				'description' => __('获取媒体库或特定页面的图片做图片轮播', 'rsg-widget')
			);

			$this->WP_Widget('RSGWidget', __('简易的图片轮播', 'rsg-widget'), $widget_ops);
		...
		public function admin_enqueue_scripts($hook) {
			...
			wp_enqueue_script('rsgwidget', $template_directory_uri . '/core/includes/really-simple-gallery-widget/js/rsgwidget.js', array('jquery'), '1.2', true);
