...
function responsive_widgets_init() {
	...
	register_sidebar(array(
		'name' => __('小工具-应用领域', 'responsive'),
		'description' => __('显示在首页的应用领域幻灯片', 'responsive'),
		'id' => 'home-widget-1',
	...
	register_sidebar(array(
		'name' => __('小工具-品牌', 'responsive'),
		'description' => __('显示在首页的品牌幻灯片', 'responsive'),
		'id' => 'home-widget-2',
	...
	register_sidebar(array(
		'name' => __('小工具-地图', 'responsive'),
		'description' => __('地图插件', 'responsive'),
		'id' => 'home-widget-3',
	...
	// register_sidebar(array(
	// 	'name' => __('关于我们-小工具-地图', 'responsive'),
	// 	'description' => __('显示在关于我们的公司地图', 'responsive'),
	// 	'id' => 'about-widget-map',
	...
	register_sidebar(array(
		'name' => __('小工具-品牌logo轮播', 'responsive'),
		'description' => __('品牌logo轮播', 'responsive'),
		'id' => 'home-widget-brands',
		'before_title' => '<div class="widget-title-home"><h3>',
		'after_title' => '</h3></div>',
		'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('小工具-产品', 'responsive'),
		'description' => __('产品幻灯片', 'responsive'),
		'id' => 'home-widget-products',
		'before_title' => '<div class="widget-title-home"><h3>',
		'after_title' => '</h3></div>',
		'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
		'after_widget' => '</div>',
	...
	register_sidebar(array(
		'name' => __('小工具-合作伙伴logo', 'responsive'),
		'description' => __('这是合作伙伴页面-合作伙伴logo轮播', 'responsive'),
		'id' => 'home-widget-logos',
		'before_title' => '<div class="widget-title-home"><h3>',
		'after_title' => '</h3></div>',
		'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
		'after_widget' => '</div>',
