...
<p>
	<label for="<?php echo $this->get_field_id('title');?>"><?php _e('Title', 'rsgwidget');
?>:</label>
	<input class="widefat" id="<?php echo $this->get_field_id('title');?>" name="<?php echo $this->get_field_name('title');?>" type="text" value="<?php echo esc_attr($title);?>" />
</p>

<p>
	<label for="<?php echo $this->get_field_id('from');?>"><?php _e('Select images from', 'rsgwidget');
?></label>
...
?>">
		<label for="<?php echo $this->get_field_id('post_id');?>"><?php _e('Page or post ID', 'rsgwidget');
?>:</label>
